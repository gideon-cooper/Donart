  ...
  return (
    <div className="about">
      ...
      <p className="has-text-centered" style={{ margin: '6rem' }}>
                Donart is a platform for donating art towards charity. Donart empowers artists to contribute towards charities and causes they care about by using their skills rather than money. It also allows buyers to support their favourite kiwi artists and know that their money has gone to a good cause.
      </p>
      <div className="aboutPage">
        <hr />
        <h2>FOUNDERS</h2>
